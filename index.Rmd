...
dt = data.frame(Dias = paste(rep(c("Segunda", 
                                   ...
                                   "Quarta", 
                                   "Quinta", 
                                   "Sexta"), each = 2), c("Manhã", "Tarde"))[1:9],
                Aula =c("Introdução e Histórico", "Introdução à Genética Quantitativa",
                        ...
                        "Seleção e a Paisagem Adaptativa", "Sem aula",
                        "Consequencias Evolutivas da Modularidade"),
                Tutorial = c("Introdução ao R", "Sem tutorial",
                             ...
                             "Sem Tutorial", "Estimando Seleção e a Matriz G",
                             "Consequências Evolutivas"),
                Professor = c("Monique", "Diogo",
                              "Diogo", "Diogo",
                              "Monique", "Monique",
                              "Diogo", "",
                              "Monique"))
